        ...
        <div className="space-y-2.5">
          ...
          >
            ...
            <div className="text-[11px] text-slate-700 truncate">
              <span className="font-medium">From:</span>{" "}
              <span className="text-slate-600 truncate">klant@example.com</span>
            </div>
            <div className="text-[11px] text-slate-700 truncate mt-1">
              <span className="font-medium">Subject:</span>{" "}
              <span className="text-slate-600 truncate">Waar blijft mijn bestelling?</span>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="flex flex-wrap items-center gap-1.5 text-[10px] text-slate-600">
              ...
              <span className="px-1.5 py-0.5 rounded bg-slate-100 text-slate-700">E-mail</span>
              <span className="px-1.5 py-0.5 rounded bg-slate-100 text-slate-700">Normaal</span>
            </div>
            <div className="mt-2 text-[10px] text-slate-600">
              Classificatie: <span className="font-medium text-slate-700">Levering</span> • 0.8s
            </div>
          </motion.div>
