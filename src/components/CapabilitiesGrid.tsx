...
const CAPABILITIES = [
  ...
  },
  {
    ...
    description: "Automatisch antwoorden op vragen over orderstatus en retourprocessen.",
    icon: "orders",
  },
  {
    title: "Verzending & tracking",
    description: "Real-time tracking informatie ophalen en doorgeven aan klanten.",
    icon: "shipping",
  },
  {
    title: "Facturen",
    description: "Factuurvragen beantwoorden en betalingsstatus opzoeken.",
    icon: "invoices",
  },
  {
    title: "Productinformatie",
    description: "Productdetails, voorraadstatus en specificaties automatisch delen.",
    icon: "products",
  },
  {
    title: "Klantdata context",
    description: "Klantgegevens, orderhistorie en voorkeuren gebruiken voor persoonlijke antwoorden.",
    icon: "customer-data",
  },
  {
    title: "Account & login",
    description: "Wachtwoord reset, accountverificatie en toegangsproblemen oplossen.",
    icon: "account",
  },
];
      ...
      <div className="mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-12 gap-8 sm:gap-12 lg:gap-16 items-center mb-12 sm:mb-16">
          <div className="lg:col-span-5 px-3 sm:px-0">
            <h2 className="text-3xl sm:text-4xl font-semibold text-slate-900 mb-6 leading-[1.15] tracking-tight">
              <span className="sm:hidden">Wat we automatiseren</span>
              <span className="hidden sm:inline">Wat Cusmato automatiseert</span>
            </h2>
            <p className="text-base sm:text-lg text-slate-600 leading-relaxed max-w-[28rem] sm:max-w-xl mx-auto sm:mx-0">
              Cusmato focust op herhaalbare klantvragen die je dagelijks krijgt via e-mail en chat.
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
          {CAPABILITIES.map((capability, idx) => {
            // On mobile (<640px): only show AI ticket automatisering, Bestellingen & retouren, and Verzending & tracking (in that order)
            const mobileVisibleCards = [
              "AI ticket automatisering",
            ...
            // Check if this is the highlighted "AI ticket automatisering" card
            const isHighlighted = capability.title === "AI ticket automatisering";
