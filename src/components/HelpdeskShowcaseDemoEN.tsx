// HelpdeskShowcaseDemoEN.tsx - Premium clean dashboard UI animation - English version
...
const INITIAL_TICKETS: Ticket[] = [
  { id: 1246, subject: "Return request", customer: "Maria J.", orderNumber: "#6237", status: "open" },
  { id: 1245, subject: "Invoice question", customer: "Peter B.", orderNumber: "#6236", status: "open" },
];
...
const AI_RESPONSE = `Hi John,

Your order #6238 is on its way and will be delivered tomorrow.
Track & trace: 94XXXX…70216.`;

const SOURCES = ["Knowledgebase", "Customer data", "Rules"];

export default function HelpdeskShowcaseDemoEN() {
                ...
                {(selectedTicket.status === "ai-processing" ||
                  ...
                  >
                    <div className="flex items-center justify-between mb-4">
                      <div className="text-xs font-semibold text-slate-900">AI draft answer</div>
