...
import { blogPostsEN, BlogPost } from "../data/blogEN";
...
// Map Dutch tags to English for display
...
const getTranslatedTag = (tag: string): string => {
  return tagTranslationMap[tag] || tag;
};
                            ...
                            <div key={`midpoint-${index}`}>
                              ...
                              <div className="hidden md:block my-12 py-8 px-6 bg-gradient-to-r from-blue-50 to-blue-100/50 rounded-xl border border-blue-200">
                                ...
                                <p className="text-slate-600 mb-4">
                                  Try Cusmato free for 14 days and discover how to automate support without losing quality.
                                </p>
                                <Link
                  ...
                  <div className="mt-16 pt-12 border-t border-slate-200">
                    ...
                    <div className="grid md:grid-cols-3 gap-6">
                      {relatedPosts.map((relatedPost) => (
                        <BlogCardEN key={relatedPost.slug} post={relatedPost} />
                      ))}
                    </div>
                  </div>
                )}
