...
export default function InHouseAIPageEN() {
  ...
  const timeline = [
    {
      period: "Jan 2024",
      title: "Start development support-ML",
      description: "Development of proprietary machine learning for e-commerce customer service.",
    },
    {
      period: "2024",
      title: "Training on e-commerce flows",
      description: "Focus on orders, returns, invoices and shipping workflows.",
    },
    {
      period: "2025",
      title: "Feedback-loop improvements",
      description: "Human approval and quality improvement integrated.",
    },
    {
      period: "Now",
      title: "Faster, more consistent and scalable",
      description: "Continuous improvement of AI logic for online stores.",
    },
  ];

  const heroConfig = subpagesHeroConfigEN["in-house-ai"];
  ...
  return (
    <>
      ...
      <div className="min-h-screen relative -mx-5 sm:mx-0">
        ...
        {/* Sectie 2 - "What makes our AI different?" (equal height cards) */}
            ...
            <div className="grid sm:grid-cols-3 gap-6 lg:gap-8 items-stretch">
              <Reveal delay={0.1}>
                ...
                >
                  ...
                  <h3 className="text-xl font-semibold text-white mb-4">Proprietary AI engine</h3>
                  <p className="text-base text-slate-300 leading-relaxed flex-grow">
                    No generic chatbot. Cusmato is built around support cases: orders, returns, shipping and invoices.
                  </p>
                </motion.div>
              </Reveal>
              ...
              <Reveal delay={0.15}>
                ...
                >
                  ...
                  <h3 className="text-xl font-semibold text-white mb-4">Context from your tools</h3>
                  <p className="text-base text-slate-300 leading-relaxed flex-grow">
                    Cusmato uses data from your connected systems to support answers and trigger actions.
                  </p>
                </motion.div>
              </Reveal>
              ...
              <Reveal delay={0.2}>
                ...
                >
                  ...
                  <h3 className="text-xl font-semibold text-white mb-4">Continuously smarter</h3>
                  <p className="text-base text-slate-300 leading-relaxed flex-grow">
                    Feedback from your team and ticket outcomes automatically improve quality.
                  </p>
                </motion.div>
              </Reveal>
            </div>
        ...
        {/* Sectie 3 - "Built since January 2024" (grote sectie met timeline cards) */}
        <section className="mb-20 sm:mb-28 lg:mb-32">
          <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="order-2 lg:order-1">
                <Reveal>
                  <h2 className="text-3xl sm:text-4xl lg:text-5xl font-semibold text-white mb-4">
                    Built since January 2024
                  </h2>
                  <p className="text-base sm:text-lg text-slate-300 mb-10 leading-relaxed">
                    We continuously build proprietary machine learning for e-commerce support: classification, intent, context and quality improvement.
                  </p>
                </Reveal>
              ...
              <div className="order-1 lg:order-2">
                <Suspense fallback={null}>
                  <PremiumImage
                    ...
                    alt="AI-driven support teams development with Cusmato"
                    aspectRatio="16/10"
                    maxWidth="lg"
                    variant="dark"
                    showGlow={false}
                    ...
                    <li className="flex items-start gap-4">
                      ...
                      <div>
                        <p className="text-base text-slate-300 leading-relaxed">
                          Context from orders, returns and customer data
                        </p>
                      </div>
                    </li>
                    <li className="flex items-start gap-4">
                      ...
                      <div>
                        <p className="text-base text-slate-300 leading-relaxed">
                          Automatically answer and trigger actions
                        </p>
                      </div>
                    </li>
                    <li className="flex items-start gap-4">
        ...
        {/* Sectie 5 - "Why in-house AI is important" (upgraded) */}
        <section className="mb-20 sm:mb-28 lg:mb-32">
          <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8">
            <Reveal>
                ...
                <div className="max-w-3xl mx-auto text-center">
                  ...
                  <ul className="space-y-5 text-left">
                    ...
                    <li className="flex items-start gap-4">
                      ...
                      <div className="pt-1">
                        <p className="text-base sm:text-lg text-slate-300 leading-relaxed">
                          Faster processing of common questions
                        </p>
                      </div>
                    </li>
                    <li className="flex items-start gap-4">
                      ...
                      <div className="pt-1">
                        <p className="text-base sm:text-lg text-slate-300 leading-relaxed">
                          Manual control possible where needed
                        </p>
                      </div>
                    </li>
                  </ul>
          ...
          <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-[50%_50%] gap-8 lg:gap-12 xl:gap-16 items-center">
              ...
              <div className="order-2 lg:order-1">
                <Reveal>
                  <h2 className="text-3xl sm:text-4xl font-semibold text-white mb-6">
                    Automate where possible, control where needed
                  </h2>
                </Reveal>
                  ...
                  <Reveal delay={0.1}>
                    <div className="bg-white/5 backdrop-blur-sm rounded-xl border border-white/10 shadow-sm p-6">
                      <div className="flex items-start gap-4">
                        ...
                        <div>
                          <h3 className="text-lg font-semibold text-white mb-2">Human approval possible</h3>
                          <p className="text-sm text-slate-400 leading-relaxed">
                            Choose per question type whether answers are sent automatically or approved first.
                          </p>
                        </div>
                      </div>
                    </div>
                  ...
                  <Reveal delay={0.15}>
                    <div className="bg-white/5 backdrop-blur-sm rounded-xl border border-white/10 shadow-sm p-6">
                      <div className="flex items-start gap-4">
                        ...
                        <div>
                          <h3 className="text-lg font-semibold text-white mb-2">Rules and workflows</h3>
                          <p className="text-sm text-slate-400 leading-relaxed">
                            Determine yourself which questions are handled automatically and which go to your team.
                          </p>
                        </div>
                      </div>
                    </div>
                  ...
                  <Reveal delay={0.2}>
                    <div className="bg-white/5 backdrop-blur-sm rounded-xl border border-white/10 shadow-sm p-6">
                      <div className="flex items-start gap-4">
                        ...
                        <div>
                          <h3 className="text-lg font-semibold text-white mb-2">Audit and consistency</h3>
                          <p className="text-sm text-slate-400 leading-relaxed">
                            Overview of all answers and actions for control and improvement.
                          </p>
                        </div>
                      </div>
                    </div>
              ...
              <div className="order-1 lg:order-2">
                <Suspense fallback={null}>
                  <PremiumImage
                    ...
                    alt="Human-approved automation with Cusmato"
                    aspectRatio="16/10"
                    maxWidth="lg"
                    variant="dark"
                    showGlow={true}
