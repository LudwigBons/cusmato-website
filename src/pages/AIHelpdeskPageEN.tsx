...
export default function AIHelpdeskPageEN() {
  ...
  const useCases = [
    {
      ...
      description: "Order status, return requests, refunds",
    },
    {
      icon: "shipping",
      title: "Shipping status & track & trace",
      description: "Delivery times, delays, carrier info",
    },
    {
      icon: "products",
      title: "Product questions",
      description: "Specifications, availability, compatibility",
    },
    {
      icon: "invoices",
      title: "Invoices & payments",
      description: "AI invoicing, payment status, VAT questions",
    },
    {
      icon: "customer-data",
      title: "Customer data & account questions",
      description: "Address changes, account updates, data",
    },
    {
      icon: "escalations",
      title: "Complaints & disputes",
      description: "Escalations, complex questions, edge cases",
    },
  ];

  const faqItems = [
    {
      question: "Can I have it approved first?",
      answer: "Yes, you can choose per question type between fully automatic, drafts that you approve, or only specific categories. You always maintain control.",
    },
    {
      question: "Does this work with Gmail/Outlook/Intercom?",
      answer: "Yes, Cusmato integrates seamlessly with Gmail, Outlook, Intercom, Zendesk and many other platforms via OAuth or API connections.",
    },
    {
      question: "How does Cusmato learn our tone of voice?",
      answer: "Cusmato analyzes your existing emails and responses to learn your writing style. You can also upload templates and examples for faster adaptation.",
    },
    {
      question: "What happens with difficult questions?",
      answer: "In case of uncertainty or complex questions, Cusmato automatically escalates to an employee. You determine the escalation rules per question type yourself.",
    },
    {
      question: "How quickly can I go live?",
      answer: "After setup and connecting your tools, you're typically live within 1-2 business days. You can then start immediately with automatic responses.",
    },
    {
      question: "Which languages do you support?",
      answer: "Cusmato works primarily with Dutch and English, and can be extended to other languages based on your templates and examples.",
    },
  ];
    ...
    <div className="min-h-screen bg-white relative overflow-x-hidden">
      ...
      <main className="pt-20 sm:pt-24 pb-12 sm:pb-16 relative z-10">
        <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
          ...
          <MobileSubpageHero
            label={subpagesHeroConfigEN["ai-helpdesk"].label}
            title={
              subpagesHeroConfigEN["ai-helpdesk"].titleMobile ? (
                <>
                  <span className="sm:hidden">{subpagesHeroConfigEN["ai-helpdesk"].titleMobile}</span>
                  <span className="hidden sm:inline">{subpagesHeroConfigEN["ai-helpdesk"].title}</span>
                </>
              ) : (
                subpagesHeroConfigEN["ai-helpdesk"].title
              )
            }
          ...
          <div className="relative z-10 max-w-[1280px] mx-auto sm:px-6 lg:px-8">
            ...
            <Reveal>
              ...
              <h2 className="text-3xl sm:text-[32px] md:text-[36px] lg:text-[40px] xl:text-[44px] font-semibold text-white mb-4 sm:mb-6 leading-[1.15]">
                ...
                <span className="hidden sm:inline">From inbox chaos to autopilot support</span>
              </h2>
              </div>
            </Reveal>
            ...
            >
              {[
                { title: "Fewer tickets, faster responses", desc: "24/7 automatic handling" },
                { title: "Always consistent", desc: "Your tone of voice in every interaction" },
                { title: "Control when you want it", desc: "Approval mode or fully autonomous" },
              ].map((stat, index) => (
                <motion.div
                  key={index}
                  variants={fadeUp}
          ...
          <Reveal>
            <div className="text-center mb-20">
              <h2 className="text-3xl sm:text-[36px] md:text-[40px] lg:text-[44px] font-semibold text-slate-900 mb-4 sm:mb-5 leading-[1.15]">
                <span className="sm:hidden">What does it automate?</span>
                <span className="hidden sm:inline">What does the AI Helpdesk automate?</span>
              </h2>
              <p className="text-base sm:text-lg text-slate-600 max-w-[28rem] sm:max-w-2xl mx-auto leading-relaxed">
                Repetitive e-commerce questions are handled automatically, 24/7 and without manual work.
              </p>
            </div>
          </Reveal>
      ...
      <StepsSection
        ...
        steps={[
          {
            number: 1,
            title: "Connect your inbox in minutes",
            description:
              "Connect your support inbox like Gmail, Outlook, Zendesk or Intercom and Cusmato immediately reads your incoming questions. No migration hassle, you can go live today.",
            chips: ["Quick setup", "Context from orders"],
            visual: <HelpdeskVisualDemo variant="default" />,
          },
          {
            number: 2,
            title: "Cusmato learns your tone of voice",
            description:
              "Cusmato analyzes your existing emails, templates and FAQs to copy your writing style. This way answers always sound as if they were written by your team.",
            chips: ["Consistent brand voice", "AI drafts per ticket"],
            visual: <HelpdeskVisualDemo variant="tone-of-voice" />,
          },
          {
            number: 3,
            title: "Automatic or with approval",
            description:
              "Choose per question type whether Cusmato may respond independently, or whether you want to review first. You always see why Cusmato suggests something and what is being sent.",
            chips: ["Auto or approval mode", "Rules per category"],
            visual: <HelpdeskVisualDemo variant="approval" />,
          },
          {
            number: 4,
            title: "Smart workflows & rules",
            description:
              "Set up rules for returns, orders, invoices and escalations. Cusmato recognizes the context and initiates the right process, including labels, routing and follow-up.",
            chips: ["Context recognition", "Automatic routing"],
            ...
            <div>
              ...
              <Reveal delay={0.1}>
                <p className="text-lg text-slate-600 mb-8 leading-[1.7]">
                  Every answer sounds like your team. Use templates for common scenarios and let Cusmato communicate consistently.
                </p>
              </Reveal>
              <Reveal delay={0.15}>
                <ul className="space-y-3">
                  {[
                    "Answers sound like your team",
                    "Templates + variants per scenario",
        ...
        <div className="max-w-[1280px] mx-auto sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-14 xl:gap-24 items-center">
            <div>
              <Reveal>
                <h2 className="text-3xl sm:text-[36px] md:text-[40px] font-semibold text-slate-900 mb-4 leading-[1.15]">
                  <span className="sm:hidden">You maintain control</span>
                  <span className="hidden sm:inline">Control when you want it</span>
                </h2>
              </Reveal>
              <Reveal delay={0.1}>
                <p className="text-lg text-slate-600 mb-10 leading-[1.7]">
                  Choose per question type between fully automatic or approve first. Automatically escalate in case of doubt.
                </p>
              </Reveal>
              <Reveal delay={0.15}>
                <ul className="space-y-3">
                  {[
                    "Autopilot: fully automatic",
                    "Review mode: approve first",
                    "Automatic escalation for complex questions",
                  ].map((item, i) => (
                    <li key={i} className="flex items-start gap-3">
                      <svg className="w-5 h-5 text-blue-600 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
          ...
          <Reveal>
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-slate-600 max-w-2xl mx-auto">
                Cusmato runs on its own AI logic for customer service: faster, more consistent and fully tailored to e-commerce workflows.
              </p>
            </div>
          </Reveal>
          <Reveal delay={0.1}>
            <div className="grid md:grid-cols-3 gap-8 mb-10">
              {[
                {
                  title: "Own AI engine",
                  description: "No generic chatbot. Cusmato is built around support cases: orders, returns, shipping and invoices.",
                  icon: (
                ...
                },
                {
                  ...
                  description: "Cusmato uses data from your connected systems to substantiate answers and initiate actions.",
                  icon: (
                    <svg className="w-5 h-5 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                {
                  title: "Continuously smarter",
                  description: "Feedback from your team and outcomes from tickets automatically improve quality.",
                  icon: (
                    <svg className="w-5 h-5 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
            <div className="order-2 lg:order-1 text-center sm:text-left">
              ...
              <p className="text-base sm:text-lg text-slate-600 mb-6 leading-relaxed">
                Cusmato handles customer questions automatically, 24/7. From order status to return processes, everything runs seamlessly without manual work.
              </p>
            </div>
              ...
              <div className="relative w-full max-w-[520px] mx-auto">
                <div className="aspect-[16/10] rounded-xl sm:rounded-2xl overflow-hidden shadow-lg border border-slate-200">
                  <img
                    ...
                    alt="Automated customer support with Cusmato AI"
    ...
    <div ref={ref} className="bg-white rounded-xl border border-slate-200/60 p-6 shadow-sm max-w-md mx-auto">
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          <h4 className="text-sm font-semibold text-slate-900">Workflow rules</h4>
          <span className="px-2 py-1 bg-green-100 text-green-700 rounded text-xs font-medium">Active</span>
        </div>
        <div className="space-y-3">
          {[
            { label: "Return request", action: "→ Automatic label" },
            { label: "Order status", action: "→ Retrieve context" },
            { label: "Escalation", action: "→ Notify employee" },
          ].map((rule, index) => (
            <motion.div
              key={index}
...
function TypewriterAnimation() {
  ...
  const fullText = "Thank you for your question. We found your order and it will be shipped today.";
        ...
        <div className="space-y-3">
          ...
          >
            ...
            <p className="text-xs text-slate-600">
              {isAuto
                ? "Answers are sent automatically"
                : "Answers are waiting for approval"}
            </p>
          </motion.div>
          ...
          {!isAuto && (
            ...
            >
              <p className="text-xs text-blue-900">
                <strong>2 drafts</strong> waiting for approval
              </p>
            </motion.div>
          )}
        </div>
...
function ControlPanel() {
  ...
  return (
    <div className="bg-white rounded-xl border border-slate-200/60 p-5 sm:p-6 lg:p-8 shadow-sm max-w-md mx-auto">
      <div className="space-y-6">
        <div>
          <h4 className="text-sm font-semibold text-slate-900 mb-4">Mode per category</h4>
          <div className="space-y-3">
            {[
              { category: "Orders", mode: "autopilot" as const },
              { category: "Returns", mode: "review" as const },
              { category: "Product questions", mode: "autopilot" as const },
            ].map((item, index) => (
        ...
        <div className="pt-4 border-t border-slate-200">
          <div className="flex items-center gap-2 text-sm text-slate-600">
            ...
            <span>Escalation in case of doubt active</span>
          </div>
        </div>
      </div>
    </div>
